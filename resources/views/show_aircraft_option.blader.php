  ...
  <section class="page-section" id="services">
    <div class="container">
      <div class="row">
        ...
        <h2 class="section-heading text-uppercase">Aircraft Information<br/></h2>
          <h2 class="section-heading text-uppercase">What would you like to see?<br/></h2>
          <br/>
          <input class="MyButton" type="button" value="All data" onclick="window.location.href='show_aircraft_single_table.blader.php'" />
          <br/><br/>
